    ...
    <CameraContext.Provider value={cameraState}>
      ...
      >
        ...
        <Box
          ...
          fontSize="24"
          color="#ffd940"
          textShadow={'-1px -1px 0 rgba(0,0,0,.50), 1px -1px 0 rgba(0,0,0,.50), -1px 1px 0 rgba(0,0,0,.50), 1px 1px 0 rgba(0,0,0,.50)'}
        >
          and the
        </Box>
        <Box
          ...
          fontSize="36"
          color="#ffd940"
          textShadow={'-2px -2px 0 rgba(0,0,0,.50), 2px -2px 0 rgba(0,0,0,.50), -2px 2px 0 rgba(0,0,0,.50), 2px 2px 0 rgba(0,0,0,.50)'}
        >
          JOB SEARCH
        </Box>
        <Box
